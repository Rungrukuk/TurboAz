...
<body>
    ...
    <!--/ Form -->
    <form method = "post" action="php/login.php" class="cont">
  ...
  <?php if(isset($_GET['success'])){ ?>
    ...
    <div>
    <button type ="submit" class="button">Daxil Ol</button>
    <a href="register.php" class="link-secondary" id = "link">Qeydiyyatdan Keç</a>
    </div>
    <p>Elan yerləşdirərək, siz Turbo.az-ın İstifadəçi razılaşması və Qaydaları ilə razı olduğunuzu təsdiq edirsiniz</p>
    </form>
     <!--/ Footer -->
<footer>
