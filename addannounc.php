            ...
            <div style="height: 100%; display: flex; gap: 30px">
              ...
              <?php if (isset($_SESSION["useremail"])) {
                ...
                <a href="php/destroysessions.php" style="cursor: pointer">
                  <img style="width: 30px"
                    src="https://upload.wikimedia.org/wikipedia/commons/8/8a/OOjs_UI_icon_logOut-ltr.svg" alt="" />
  ...
  <form enctype='multipart/form-data' method="post" action="php/check_infos.php" class="cont">
    ...
    <div class="form-elements">
      ...
      <div style="display: inline">
        <input name="yurus" type="number" step="1000" min="0" max=""
    ...
    <div class="form-elements">
      ...
      <!-- <input type="text" style="border: 1px solid gray; border-radius: 4px;"> -->
      <div>
        <input name="qiymet" type="number" step="1" min="500" max=""
          style="width: 90px; border: 1px solid gray; border-radius: 4px" />
        <input type="checkbox" name="distance" />
      ...
      <input name="muherrikingucu" type="number" step="1" min="1" max=""
